...
from active_criterion.label_pro_only import label_pro_only
...
class active_label_pro_batch(object):
    ...
    def train_active(self):
        ...
        while 1:
            ...
            # rbf
            Inconsis_index = label_pro_only(self.label_data, self.unlabel_data, self.unlabel_output,self.label_target, self.batch_num, self.rbf_distance)
            # before update label_data和unlabel_data，update rbf_distance
